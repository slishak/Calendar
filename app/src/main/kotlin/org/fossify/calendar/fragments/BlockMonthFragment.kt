...
import org.fossify.calendar.databinding.FragmentBlockMonthBinding
...
class BlockMonthFragment : Fragment(), MonthlyCalendar {
    ...
    private lateinit var binding: FragmentBlockMonthBinding
    private lateinit var topNavigationBinding: TopNavigationBinding

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        binding = FragmentBlockMonthBinding.inflate(inflater, container, false)
    ...
    private fun setupButtons() {
        ...
        topNavigationBinding.topLeftArrow.apply {
            ...
            background = null
            setOnClickListener { listener?.goLeft() }
        ...
        topNavigationBinding.topRightArrow.apply {
            applyColorFilter(mTextColor)
            background = null
            setOnClickListener { listener?.goRight() }
    ...
    private fun updateDays(days: ArrayList<DayMonthly>) {
        binding.blockMonthView.setDayClickCallback { day ->
            DayAgendaBottomSheet.newInstance(day.code)
                .show(parentFragmentManager, "day_agenda")
        }
        binding.blockMonthView.updateDays(days)
    }
    ...
    fun printCurrentView() {
        topNavigationBinding.apply {
            ...
            topValue.setTextColor(resources.getColor(org.fossify.commons.R.color.theme_light_text_color, null))
            requireContext().printBitmap(binding.blockMonthCalendarHolder.getViewBitmap())
