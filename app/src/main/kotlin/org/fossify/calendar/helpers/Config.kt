...
class Config(context: Context) : BaseConfig(context) {
    ...
    var hidePastEventsInWidgets: Boolean
        get() = prefs.getBoolean(HIDE_PAST_EVENTS_IN_WIDGETS, false)
        set(v) = prefs.edit().putBoolean(HIDE_PAST_EVENTS_IN_WIDGETS, v).apply()
